...
- [ ] **Step 4: Record exact baseline counts in the progress ledger**
...
- [ ] **Step 1: Add tests for Domain reverse dependencies**
...
- [ ] **Step 2: Add tests for Application reverse and framework dependencies**
...
- [ ] **Step 3: Add tests for Worker/plugin control-plane and database dependencies**
...
- [ ] **Step 5: Implement the minimal AST checks**
...
- [ ] **Step 6: Run against the current source and observe the intended module violations**
...
### Task 3: Invert Feedback dependencies
...
- [ ] **Step 3: Move the enum inward and define the port**
...
- [ ] **Step 4: Make the handler depend only on Domain/Application**
...
- [ ] **Step 5: Verify focused behavior and architecture GREEN**
...
### Task 4: Invert User Settings persistence
...
- [ ] **Step 1: Add failing Handler tests against a stub port**
...
- [ ] **Step 3: Add the Application repository port**
...
- [ ] **Step 4: Verify focused behavior and architecture GREEN**
...
### Task 5: Separate report rendering adapters from HTTP
...
- [ ] **Step 1: Add report export compatibility tests**
...
- [ ] **Step 3: Introduce runtime-compatible typed report contracts**
...
- [ ] **Step 4: Introduce renderer ports and export service**
...
- [ ] **Step 5: Move renderers to Infrastructure and inject them in Bootstrap**
...
- [ ] **Step 6: Verify report and API compatibility GREEN**

Run: `uv run pytest apps/control-api/tests/unit/reports apps/control-api/tests/contract/test_reports_api.py -q`

Expected: all report tests pass with no API-to-Infrastructure import.

### Task 6: Validate all execution boundaries
...
- [ ] **Step 2: Run Worker and plugin tests**
...
- [ ] **Step 3: Run Workflow replay, retry, timeout, cancellation, and idempotency suites**
...
### Task 7: Execute complete non-regression gates
...
- [ ] **Step 1: Run all quality and contract gates**
...
- [ ] **Step 2: Run PostgreSQL migration and isolation integration tests**
...
- [ ] **Step 3: Run performance and security gates**
...
- [ ] **Step 4: Run complete Playwright**
...
- [ ] **Step 5: Verify compatibility and repository cleanliness**
...
- [ ] **Step 6: Complete independent review and documentation**

Review for behavior changes, missed reverse dependencies, security regressions and false-positive architecture rules. Move `TASK-20260717-002` to completed only after every required verification has evidence; otherwise mark it `待验证` with exact risk.
