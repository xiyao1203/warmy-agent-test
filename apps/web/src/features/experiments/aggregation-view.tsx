  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-4 gap-2">
        <div className="rounded-[var(--radius-lg)] border border-[var(--hairline)] p-3 text-center">
          <p className="text-xs text-[var(--muted)]">总计</p>
          <p className="text-2xl font-bold">{total_cases}</p>
        </div>
        <div className="rounded-[var(--radius-lg)] border border-[var(--success)] bg-[var(--success-subtle)] p-3 text-center">
          <p className="text-xs text-[var(--muted)]">通过</p>
          <p className="text-2xl font-bold text-[var(--success)]">{passed}</p>
        </div>
        <div className="rounded-[var(--radius-lg)] border border-[var(--danger)] bg-[var(--danger-subtle)] p-3 text-center">
          <p className="text-xs text-[var(--muted)]">失败</p>
          <p className="text-2xl font-bold text-[var(--danger)]">{failed}</p>
        </div>
        <div className="rounded-[var(--radius-lg)] border border-[var(--hairline)] p-3 text-center">
          <p className="text-xs text-[var(--muted)]">通过率</p>
      ...
      <div className="rounded-[var(--radius-lg)] border border-[var(--hairline)] p-4">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div>
            <p className="text-xs text-[var(--muted)]">P50</p>
            <p className="text-lg font-semibold">{latency.p50.toFixed(0)}</p>
          </div>
          <div>
            <p className="text-xs text-[var(--muted)]">P95</p>
