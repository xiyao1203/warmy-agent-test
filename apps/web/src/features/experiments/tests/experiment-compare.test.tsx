...
describe("AggregationView", () => {
  const mockStats = {
    ...
    failed: 2,
    pass_rate: 0.8,
    latency: { avg: 1200, p50: 1000, p95: 2500, std_dev: 300, min_val: 500, max_val: 3000 },
    score: { avg: 0.82, p50: 0.85, p95: 0.65, std_dev: 0.12, min_val: 0.5, max_val: 1.0 },
    cost: { avg: 0.05, p50: 0.04, p95: 0.12, std_dev: 0.02, min_val: 0.01, max_val: 0.15 },
  };
  ...
  const mockProps = {
    ...
    runB: {
      ...
      statistics: {
        ...
        failed: 3,
        pass_rate: 0.7,
        latency: { avg: 1500, p50: 1200, p95: 3000, std_dev: 400, min_val: 600, max_val: 4000 },
        score: { avg: 0.75, p50: 0.78, p95: 0.55, std_dev: 0.15, min_val: 0.4, max_val: 1.0 },
        cost: { avg: 0.06, p50: 0.05, p95: 0.15, std_dev: 0.03, min_val: 0.02, max_val: 0.20 },
      },
    },
    degradations: [
      { case_id: "tc1", metric: "score", baseline: 0.9, current: 0.5, change: -0.44 },
    ],
  };
