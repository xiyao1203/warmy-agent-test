...
import {
  ...
  MappingsSection,
} from "./agent-version-advanced-sections";
import { TargetSection } from "./agent-version-target-section";
import { LimitsSection, MetadataSection } from "./agent-version-sections";
  ...
  async function submit() {
    ...
    try {
      const payload = buildAgentVersionPayload({
        ...
        codeVersion,
        costLimit,
        credential: { bindingId: credentialId },
