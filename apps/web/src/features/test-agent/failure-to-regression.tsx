    ...
    <div className="space-y-4 rounded border border-[var(--hairline)] p-4">
      ...
      <div className="max-h-60 space-y-2 overflow-y-auto">
        {failures.map((failure) => (
          <label
            key={failure.id}
            className="flex cursor-pointer items-start gap-3 rounded border border-[var(--hairline)] p-3 hover:bg-[var(--bg-secondary)]"
          >
            <input
              type="checkbox"
            ...
            <div className="flex-1 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div>
                  <span className="text-[var(--muted)]">输入：</span>
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          className="flex items-center gap-2 rounded bg-[var(--primary)] px-4 py-2 text-sm text-white disabled:opacity-50"
