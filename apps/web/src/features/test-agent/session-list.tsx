...
export function SessionList({
  ...
  return (
    <aside className="flex min-h-0 flex-col border-r border-[var(--hairline)] bg-[var(--surface)]">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-2" aria-label="会话历史">
        ...
        {items.map((item) => (
          <button
            ...
            className={`mb-1 w-full rounded-[var(--radius-md)] px-3 py-2 text-left text-sm transition-colors ${
