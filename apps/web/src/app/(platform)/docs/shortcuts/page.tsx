    ...
    <div className="mx-auto max-w-[700px] px-6 py-8">
      ...
      <header className="mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold tracking-tight">键盘快捷键</h1>
      ...
      <div className="mt-8 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5">
        ...
        <p className="mt-2 text-sm text-[var(--text-muted)]">
          在 macOS 上使用 <kbd className="rounded border border-[var(--border)] bg-[var(--surface-subtle)] px-1.5 py-0.5 text-xs">⌘</kbd> 键，
          在 Windows/Linux 上使用 <kbd className="rounded border border-[var(--border)] bg-[var(--surface-subtle)] px-1.5 py-0.5 text-xs">Ctrl</kbd> 键。
        </p>
      </div>
    </div>
  );
