      ...
      <div className="space-y-6">
        {shortcutGroups.map((group) => (
          ...
          >
            ...
            <dl className="overflow-hidden rounded-[var(--radius-lg)] border border-[var(--hairline)] bg-[var(--surface)]">
              {group.shortcuts.map((shortcut) => (
                <div
                  className="flex items-center justify-between gap-4 border-b border-[var(--hairline)] px-4 py-3 last:border-b-0"
                ...
                >
                  ...
                  <dd className="flex shrink-0 items-center gap-1">
                    {shortcut.keys.map((key) => (
                      <kbd
                        className="min-w-7 rounded-[var(--radius-md)] border border-[var(--hairline-strong)] bg-[var(--canvas-soft)] px-2 py-1 text-center font-mono text-xs text-[var(--muted)] shadow-sm"
                        key={key}
                      >
                        {key}
                      </kbd>
